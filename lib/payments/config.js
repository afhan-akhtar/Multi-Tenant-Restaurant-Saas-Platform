...
export function getStripeTerminalConfig() {
  return {
    enabled: isStripeConfigured(),
    simulated: isTruthyEnv(process.env.STRIPE_TERMINAL_SIMULATED),
    locationId:
      process.env.NEXT_PUBLIC_STRIPE_TERMINAL_LOCATION_ID ||
  ...
  return {
    ...
    providers: {
      stripe: {
        ...
        terminal: getStripeTerminalConfig(),
      },
      paypal: {
