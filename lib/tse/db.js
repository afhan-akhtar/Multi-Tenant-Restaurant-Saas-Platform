 ...
 * @returns {Promise<{ signature: string, transactionId: string, signedAt: Date, tss_id?: string, tx_id?: string, signature_counter?: number, log_time_start?: string|null, log_time_end?: string|null } | null>}
 */
