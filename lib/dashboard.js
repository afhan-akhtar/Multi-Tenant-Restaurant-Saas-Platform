...
export async function getDashboardData(tenantId = null, userType = "staff") {
  ...
  return {
    ...
    metrics: {
      revenue: Eur(revenue),
      taxCollected: Eur(taxCollected),
      taxThisMonth: Eur(taxThisMonth),
      todaySales: Eur(todaySales),
      todayTax: Eur(todayTax),
      salesReturn: Eur(salesReturn),
      profit: Eur(revenue - salesReturn),
      totalCustomers: customers,
      pendingOrders: pendingOrders,
      avgOrderValue: Eur(avgOrderValue),
...
export async function getSuperAdminDashboardData() {
  ...
  return {
    ...
    metrics: {
      ...
      platformRevenue: Eur(toNum(orderStats._sum.grandTotal)),
      totalOrders: orderStats._count,
      commissionEarned: Eur(toNum(paymentStats._sum.amount || invoiceStats._sum.totalAmount)),
    },
